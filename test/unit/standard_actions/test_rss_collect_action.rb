...
require_relative '../../../lib/armagh/standard_actions/rss_collect_action'

class TestRSSCollectAction < Test::Unit::TestCase
  ...
  def setup
    ...
    @config = Armagh::StandardActions::RSSCollectAction.create_configuration([], 'test', @config_values)
    @rss_collect_action = instantiate_action(Armagh::StandardActions::RSSCollectAction, @config)
  end
