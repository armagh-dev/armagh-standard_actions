...
require_relative '../../../lib/armagh/standard_actions/html_publish_action'
require_relative '../../helpers/actions_test_helper'

class TestHTMLPublishAction < Test::Unit::TestCase
  include ActionsTestHelper

  def setup
    @html_publish_action = instantiate_action(Armagh::StandardActions::HTMLPublishAction, mock('config'))
