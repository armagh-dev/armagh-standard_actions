...
require_relative '../../../lib/armagh/standard_actions/xml_split_action'
...
class TestXMLSplitAction < Test::Unit::TestCase
  ...
  def test_split_with_valid_xml
    ...
    Armagh::StandardActions::XMLSplitAction.any_instance.stubs(:edit).yields(new_docs[0]).yields(new_docs[1]).yields(new_docs[2])
    Armagh::StandardActions::XMLSplitAction.any_instance.expects(:notify_ops).never
    Armagh::Support::XML::Splitter.stubs(:split).once.returns(chunks)
    xml_splitter_action = instantiate_action(Armagh::StandardActions::XMLSplitAction, @config)
  ...
  def test_split_with_invalid_xml
    ...
    Armagh::StandardActions::XMLSplitAction.any_instance.expects(:edit_document).never
    Armagh::StandardActions::XMLSplitAction.any_instance.expects(:notify_ops).at_least_once
