...
require_relative '../../../../lib/armagh/standard_actions/publishers/pdf_publish'
require_relative '../../../helpers/actions_test_helper'

class TestPDFPublish < Test::Unit::TestCase
  include ActionsTestHelper

  def setup
    @pdf_publish_action = instantiate_action(Armagh::StandardActions::PDFPublish, mock('config'))
