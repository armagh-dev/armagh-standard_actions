...
require_relative '../../../../lib/armagh/standard_actions/publishers/office_publish'
require_relative '../../../helpers/actions_test_helper'

class TestOfficePublish < Test::Unit::TestCase
  include ActionsTestHelper

  def setup
    @office_publish_action = instantiate_action(Armagh::StandardActions::OfficePublish, mock('config'))
