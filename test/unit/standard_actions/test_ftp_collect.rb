...
require_relative '../../../lib/armagh/standard_actions/ftp_collect.rb'
...
class TestFTPCollect < Test::Unit::TestCase
  ...
  def setup  
    ...
    @config_values = {
      'output' => { 'collected_document' => Armagh::Documents::DocSpec.new( 'dans_out', Armagh::Documents::DocState::READY )},
