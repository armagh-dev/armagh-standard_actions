...
require_relative '../../../lib/armagh/standard_actions/excel_publish_action'
require_relative '../../helpers/actions_test_helper'

class TestExcelPublishAction < Test::Unit::TestCase
  include ActionsTestHelper

  def setup
    @excel_publish_action = instantiate_action(Armagh::StandardActions::ExcelPublishAction, mock('config'))
