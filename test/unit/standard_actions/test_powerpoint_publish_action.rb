...
require_relative '../../../lib/armagh/standard_actions/powerpoint_publish_action'
require_relative '../../helpers/actions_test_helper'

class TestPowerPointPublishAction < Test::Unit::TestCase
  include ActionsTestHelper

  def setup
    @powerpoint_publish_action = instantiate_action(Armagh::StandardActions::PowerPointPublishAction, mock('config'))
